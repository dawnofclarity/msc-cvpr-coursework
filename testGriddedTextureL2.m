%% Gridded Texture (Edge orientation), Euclidian L2 Distance
...
[ALLFEAT, ALLFILES] = loadDescriptors('griddedTextureQ10');
...
showSingleSearchResult(data, elapsedTime, 'Gridded Texture with L2 Norm Distance');
