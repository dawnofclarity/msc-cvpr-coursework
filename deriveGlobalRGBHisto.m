%% Derive a descriptor for Global RGB Histo
%
% Inputs:
%  img - an RGB image where pixels have RGB values in range 0-255
%  Q   - the level of quantization of the RGB space e.g. 4
%        describes how many levels of quantisation we use to create our
%        descriptor (valid levels = n^2)

function H = deriveGlobalRGBHisto(img, Q)
