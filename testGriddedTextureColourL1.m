%% Gridded Texture (Edge orientation) with Colour, Euclidian L1 Distance
...
showSingleSearchResult(data, elapsedTime, 'Gridded Texture and Colour with L1 Norm Distance');
